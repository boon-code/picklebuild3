...
This module implements the CustomPbgui class. It's implemented
in this extra module, because the original class is autogenerated.
This way, it's easier to not get the file messed up by the guibuilder
program (although it would support it, but it's a bit trickey).
This way, it's seperated (and maybe a little bit more difficulty to
read).
"""
